...
class Pythia8(MCRun):
    ...
    def _cross_section(self, kin=None):
        ...
        #   pythia.info.sigmaTot() are the estimated cross-section values for the equivalent
        # pp collision for each sub-processes.
        #   pythia.info.sigmaGen(i) are the cross-section values generated by the MC events
        # for each subprocesses. Best is to grab these values at the end of the event generation
        # when the full statistics is available.
        # The subprocesses are defined with codes in Pythia:
        #    i   subprocess
