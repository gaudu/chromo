...
class Pythia8(MCRun):
    ...
    def _cross_section(self, kin=None):
        ...
        #   pythia.info.sigmaTot() are the estimated cross-section values for the 
        # equivalent pp collision for each sub-processes.
        ...
        # event generation when the full statistics is available.
